...
\midrule
en\biarrow  cs &    tba &         tba &       tba \\
en\biarrow  de &    tba &         tba &       tba \\
en\biarrow  ru &    tba &         tba &       tba \\
en\biarrow  uk &    tba &         tba &       tba \\
en\biarrow  zh &    tba &         tba &       tba \\
cs\biarrow  uk &    tba &         tba &       tba \\
de\biarrow  fr &    tba &         tba &       tba \\
\addlinespace
Macro-Avg. &  tba & tba & tba \\
\bottomrule
\end{tabular}
"""
...
datasets = [dataset for dataset in datasets if not dataset.is_indirect and dataset.type == "pre-nmt"]
